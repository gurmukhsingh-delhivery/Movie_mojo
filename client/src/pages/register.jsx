...
const Register = ()=>{
    ...
    const [formData, setFormData] = useState({
      ...
      const validateForm = () => {
        ...
        if(formData.password.localeCompare(formData.confirm_password) != 0) samePassError= "confirm password and password are not same";
              ...
              >
                ...
                <div>
                  ...
                  />
                    ...
                    {formErrors.samePass && <p className='text-red-600'>{formErrors.samePass}</p>}
                </div>
